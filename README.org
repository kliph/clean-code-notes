...
Martin seems to be crying out for [[https://en.m.wikipedia.org/wiki/Literate_programming][literate programming]] to help keep comments current, by which I mean code-driven (and, in homoiconic languages, therefore, data-driven).
...
I just don't get why clean comments aren't important.  Martin's thesis seems to be: All comments are bad except for a few, and you should feel bad if you write them.  What?
